...
\+ `rw` minDistance: `float`
 
\+ `rw` maxDistance: `float`
...
\+ `rw` gameMode: `GameMode`
 
\+ `rw` name: `string`
 
\+ `rw` minVerticalRotation: `float`
 
\+ `rw` maxVerticalRotation: `float`
 
\+ `rw` minHorizontalRotation: `float`
 
\+ `rw` maxHorizontalRotation: `float`
 
\+ `rw` type: `string`
 
\+ `rw` families: `array`
 
\+ `rw` volume: `BlockAreaSize`
